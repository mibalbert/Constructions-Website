...
const ExamplePrice = () => {
  return (
    ...
    <section className="mx-auto border-dashed max-w-7xl border-x border-neutral-300">
      <div className="w-full text-xl font-semibold text-center text-neutral-500">
        OUR TEMPLATE HOME:
      </div>
      <div className="w-full h-full p-4 ">
        <div className="grid grid-cols-2 border border-dashed rounded-lg border-neutral-400">
